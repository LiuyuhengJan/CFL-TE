...
def get_parser():
    ...
    parser.add_argument('--actor_lr', type=float, default=1e-5, help='Learning rate for the actor network')
    ...
    parser.add_argument('--d_model', type=int, default=256, help='Dimension of input embeddings')
